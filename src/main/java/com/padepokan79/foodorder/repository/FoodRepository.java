...
public interface FoodRepository extends JpaRepository<Food, Integer>{
    ...
    Page<FoodWithFavorite> findAllWithFavorite(Pageable pageable, @Param("userId") Integer userId);
    ...
    @Query("""
            ...
            """)
    Page<FoodWithFavorite> findAllCustomViewByUserId(Pageable pageable, @Param("userId") Integer userId);
    ...
    @Query("""
            ...
            """)
    Optional<FoodWithFavorite> findByIdWithFavorite(@Param("foodId") Integer foodId, @Param("userId") Integer userId);
    ...
    @Query("""
            ...
            """)
    Page<FoodWithFavorite> findAllFavorite(Pageable pageable, @Param("userId") Integer userId);
    ...
    @Query("""
            ...
            LEFT JOIN FavoriteFood ff ON ff.food.foodId = f.foodId AND ff.user.userId = :userId
            LEFT JOIN Cart c ON c.user.userId = :userId AND c.food.foodId = f.foodId
            WHERE (:foodName IS NULL OR LOWER(f.foodName) LIKE :foodName) 
                AND 
                (:categoryId IS NULL OR f.category.categoryId = :categoryId)
            """)
    Page<FoodWithFavorite> findAllWithSpec(
